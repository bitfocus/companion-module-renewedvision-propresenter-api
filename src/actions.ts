...
export function GetActions(instance: InstanceBaseExt<DeviceConfig>): CompanionActionDefinitions {
	const actions: { [id in ActionId]: CompanionActionDefinition | undefined } = {
		...
		[ActionId.activePresentationOperation]: {
			...
			options: [options.active_presentation_operation, options.index, options.group_id_dropdown, options.group_id_text, options.timeline_operation, options.max_num_slides, options.max_num_words, options.var_start],
			callback: async (actionEvent) => {
